    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
        ...
        if ($result->num_rows == 1) {
            ...
            <form action="update_ticket.php" method="post">
                ...
                <input type="date" id="receiving_date" name="receiving_date" value="<?php echo $row["ReceivingDate"]; ?>" required><br><br>
                ...
                <label for="maintenance_person">Maintenance Person:</label>
                ...
                <label for="note_from_maintenance">Note from Maintenance:</label><br>
